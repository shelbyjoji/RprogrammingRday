...
prob=predict(both2,type=c("response"))
train2$prob=prob
g <- roc(heart_disease_present ~ prob, data = train2)
plot(g, col=rainbow(7), main="ROC curve", xlab="Specificity", 
     ylab="Sensitivity")    


cm<-table(prob > 0.5,train2$heart_disease_present)
